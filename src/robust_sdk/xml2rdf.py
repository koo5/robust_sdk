...
class Xml2rdf():
	...
	def xml2rdf(self, xml, destdir: pathlib.Path):
		...
		if self.xml_request is None:
			logger.info('Not an investment calculator XML file')
			return None
	...
	def add_report_details_sheet(self):
		...
		taxonomy1 = BNode(); self.g.add((taxonomy1, V1['account_taxonomies#url'],  self.assert_value(V1['account_taxonomies#legacy'])))
		taxonomy2 = BNode(); self.g.add((taxonomy2, V1['account_taxonomies#url'],  self.assert_value(V1['account_taxonomies#investments__legacy2'])))
